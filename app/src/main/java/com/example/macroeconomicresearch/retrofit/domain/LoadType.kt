...
val MacroLoadType = listOf(EnumKey("NY.GDP.MKTP.KD.ZG", "GDP Growth Range"),EnumKey("NY.GDP.MKTP.CD", "GDP (USD)"),EnumKey("BX.KLT.DINV.WD.GD.ZS", "FDI Inflows (USD)"), EnumKey("BM.KLT.DINV.WD.GD.ZS", "FDI Outflows (USD)"))